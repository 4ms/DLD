...
//	int32_t t,t2;
	...
	for (channel=0;channel<2;channel++)
	{
		...
		{*/
			...
			if ((REVSW_CH1 && channel==0) || (REVSW_CH2 && channel==1))
		...
		else if (switch1_val==0b01) time_mult[channel] = time_mult[channel] * 0.125; //switch down: eighth notes
